...
object SwapETHForExactTokensMethodFactory : ContractMethodFactory {
    ...
    override val methodId = ContractMethodHelper.getMethodId(io.dexnet.uniswapkit.contract.SwapETHForExactTokensMethod.Companion.methodSignature)
    ...
    override fun createMethod(inputArguments: ByteArray): ContractMethod {
        ...
        return io.dexnet.uniswapkit.contract.SwapETHForExactTokensMethod(
            amountOut,
            path,
            to,
            deadline
