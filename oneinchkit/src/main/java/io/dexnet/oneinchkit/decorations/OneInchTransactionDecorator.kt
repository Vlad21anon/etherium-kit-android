...
import io.dexnet.oneinchkit.contracts.v4.SwapMethodV4
import io.dexnet.oneinchkit.contracts.v4.UnoswapMethodV4
import io.dexnet.oneinchkit.contracts.v4.UnparsedSwapMethodV4
import io.dexnet.oneinchkit.contracts.v5.SwapMethodV5
import io.dexnet.oneinchkit.contracts.v5.UnoswapMethodV5
import io.dexnet.oneinchkit.contracts.v5.UnparsedSwapMethodV5
    ...
    override fun decoration(
        ...
        when (contractMethod) {
            ...
            is UnparsedSwapMethodV4, is UnparsedSwapMethodV5 -> {
                ...
                val incomingTokenAmount = getTokenAmount(eventInstances, true)?.let { io.dexnet.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(it.first, it.second) }
                val outgoingTokenAmount = getTokenAmount(eventInstances, false)?.let { io.dexnet.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(it.first, it.second) }

                when {
                    outgoingEth > BigInteger.ZERO -> {
                        tokenAmountIn = io.dexnet.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(OneInchDecoration.Token.EvmCoin, outgoingEth)
                        tokenAmountOut = incomingTokenAmount
                    }
                    outgoingEth < BigInteger.ZERO -> {
                        tokenAmountIn = outgoingTokenAmount
                        tokenAmountOut = io.dexnet.oneinchkit.decorations.OneInchUnknownDecoration.TokenAmount(OneInchDecoration.Token.EvmCoin, outgoingEth)
                    }
                    else -> {
                        tokenAmountIn = outgoingTokenAmount
                        tokenAmountOut = incomingTokenAmount
                ...
                return io.dexnet.oneinchkit.decorations.OneInchUnknownDecoration(
                    to,
                    tokenAmountIn,
                    tokenAmountOut
                )
