...
import io.dexnet.ethereumkit.api.core.*
...
import io.dexnet.ethereumkit.api.models.EthereumKitState
import io.dexnet.ethereumkit.api.storage.ApiStorage
import io.dexnet.ethereumkit.core.signer.Signer
import io.dexnet.ethereumkit.core.storage.Eip20Storage
import io.dexnet.ethereumkit.core.storage.TransactionStorage
import io.dexnet.ethereumkit.core.storage.TransactionSyncerStateStorage
import io.dexnet.ethereumkit.crypto.CryptoUtils
import io.dexnet.ethereumkit.crypto.InternalBouncyCastleProvider
import io.dexnet.ethereumkit.decorations.DecorationManager
import io.dexnet.ethereumkit.decorations.EthereumDecorator
import io.dexnet.ethereumkit.decorations.TransactionDecoration
import io.dexnet.ethereumkit.models.*
import io.dexnet.ethereumkit.network.*
import io.dexnet.ethereumkit.transactionsyncers.EthereumTransactionSyncer
import io.dexnet.ethereumkit.transactionsyncers.InternalTransactionSyncer
import io.dexnet.ethereumkit.transactionsyncers.TransactionSyncManager
        ...
        fun getInstance(
            ...
            val syncer: IRpcSyncer = when (rpcSource) {
                ...
                is RpcSource.Http -> {
                    ...
                    io.dexnet.ethereumkit.api.core.ApiRpcSyncer(
                        apiProvider,
                        connectionManager,
                        chain.syncInterval
                    )
