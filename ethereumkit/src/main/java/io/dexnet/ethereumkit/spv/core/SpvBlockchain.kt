...
import io.dexnet.ethereumkit.api.jsonrpc.models.RpcBlock
import io.dexnet.ethereumkit.api.jsonrpc.models.RpcTransaction
import io.dexnet.ethereumkit.api.jsonrpc.models.RpcTransactionReceipt
import io.dexnet.ethereumkit.api.models.AccountState
import io.dexnet.ethereumkit.core.EthereumKit.SyncError
import io.dexnet.ethereumkit.core.EthereumKit.SyncState
import io.dexnet.ethereumkit.core.IBlockchain
import io.dexnet.ethereumkit.core.IBlockchainListener
...
import io.dexnet.ethereumkit.spv.helpers.RandomHelper
...
import io.dexnet.ethereumkit.spv.net.PeerGroup
import io.dexnet.ethereumkit.spv.net.PeerProvider
import io.dexnet.ethereumkit.spv.net.handlers.*
import io.dexnet.ethereumkit.spv.net.tasks.HandshakeTask
...
class SpvBlockchain(
    ...
    private val blockSyncer: io.dexnet.ethereumkit.spv.core.BlockSyncer,
    private val accountStateSyncer: io.dexnet.ethereumkit.spv.core.AccountStateSyncer,
    ...
    io.dexnet.ethereumkit.spv.core.BlockSyncer.Listener, io.dexnet.ethereumkit.spv.core.AccountStateSyncer.Listener, TransactionSender.Listener {
    ...
    companion object {
        fun getInstance(storage: ISpvStorage, transactionBuilder: TransactionBuilder, rpcApiProvider: IRpcApiProvider, network: INetwork, address: Address, nodeKey: ECKey): SpvBlockchain {
            ...
            val blockSyncer =
                io.dexnet.ethereumkit.spv.core.BlockSyncer(storage, blockHelper, blockValidator)
            val accountStateSyncer =
                io.dexnet.ethereumkit.spv.core.AccountStateSyncer(storage, address)
