...
object SwapExactTokensForTokensMethodFactory : ContractMethodFactory {
    override val methodId = ContractMethodHelper.getMethodId(io.dexnet.uniswapkit.contract.SwapExactTokensForTokensMethod.Companion.methodSignature)
    ...
    override fun createMethod(inputArguments: ByteArray): ContractMethod {
        ...
        return io.dexnet.uniswapkit.contract.SwapExactTokensForTokensMethod(
            amountIn,
            amountOutMin,
            path,
            to,
