package io.dexnet.ethereumkit.sample.modules.uniswapV3
...
import io.dexnet.ethereumkit.sample.modules.main.GasPriceHelper
...
class UniswapV3ViewModel(
    ...
    private val erc20Adapter: io.dexnet.ethereumkit.sample.core.Erc20Adapter,
    ...
    val fromToken: Erc20Token? = io.dexnet.ethereumkit.sample.Configuration.erc20Tokens[5]
    val toToken: Erc20Token? = io.dexnet.ethereumkit.sample.Configuration.erc20Tokens[3]
